...
const Forgot = () => {
  ...
  return (
    ...
    <div className="max-w-md w-full space-y-8">
      <div>
        <Image className="mx-auto h-20 w-auto" src="jaipa circle.png" alt="Workflow"/>
        <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">Forgot your password?</h2>
        <p className="mt-2 text-center text-sm text-gray-600">
          Or
          <Link href={'/login'} className="font-medium text-purple-600 hover:text-purple-500"> Login</Link>
        </p>
      </div>
