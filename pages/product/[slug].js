            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="flex">
                ...
                <button
                  ...
                  className="flex ml-auto text-white bg-purple-500 border-0 py-2 px-2.5 md:px-6 focus:outline-none hover:bg-purple-600 rounded"
                >
                  Buy Now
                </button>
                <button
                  ...
                  className="flex ml-2 text-white bg-purple-500 border-0 py-2 px-2.5 md:px-6 focus:outline-none hover:bg-purple-600 rounded"
                >
                  Add to cart
                </button>
              </div>
