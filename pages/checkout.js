...
/>
      ...
      <div className="sidecart bg-purple-100 p-6 m-2">
      ...
      <div className="">
        <Link href={"/checkout"} passHref>
          <button
            ...
            className="disabled:bg-purple-300 flex mx-2  text-white bg-purple-500 border-0 py-2 px-2 focus:outline-none hover:bg-purple-600 rounded text-sm"
          >
            <IoBagCheck className=" m-1 text-sm" />
            Pay ₹{subTotal}
          </button>
        </Link>
      </div>
